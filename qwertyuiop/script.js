...
const update = () => {
  ...
  container.style.backgroundPositionY = -progress * 20 + "px"; // parallax-effect
  ...
  if (isNumberInRange(progress, number)) {
    ...
    if (language == "english") {
      ...
      contentText = [
        ...
        "<span>SCHMUCKSTÜCKE VON PAuNN<br>SIND HANDGEFERTIGT UND<br>ETHISCH KORREKT PRODUZIERT<span/>",
        "<span>QUALITÄT UND<br>SELBSTVERSTÄNDLICH AuCH<br>WERTERHALT STEHEN BEI UNSEREM SCHMUCK STETS IM VORDERGRUND<span/>",
    ...
    frameLocation.style.innerHTML = locationText;
  } else {
